...
<html>
	...
	<body>
		<div class="f_show">
			<div class="f_photo">
				<img src="img/second.img/mango1.jpg" id="showphoto">
			</div>
		
			<div class="f_information">
				
				<div class="f_name">
					<h3><span id="trade_name">蜜鲜果城：</span>十记庄园 海南<span id="proName">贵妃芒精品果</span>4斤 新鲜水果海南红金龙芒果</h3>
					<p id="slogan">【头茬芒果,鲜嫩美味】拍2件合包裹8斤发~精选单果80-120g的黄金比例果；皮薄核小,清甜多汁!</p>
				</div>
			
				<div class="f_price">
					<div id="price1">
						<p >价&nbsp;格<span id="proPrice">25.50￥</span></p>
					</div>
					<div id="price2">
						<p >促&nbsp;销<span id="promotion">满60元减16元，买三送一！</span></p>
					</div>
				</div>
				<div class="f_id">
					<span>水果编号：<span id="proId">112</span></span>
				</div>
			...
			<ul id="photolist">
				<li><img src="img/second.img/mango1.jpg" onclick="changephoto(this)"></li>
				<li><img src="img/second.img/mango2.jpg" onclick="changephoto(this)"></li>
				<li><img src="img/second.img/mango3.jpg" onclick="changephoto(this)"></li>
				<li><img src="img/second.img/mango4.jpg" onclick="changephoto(this)"></li>
				<li><img src="img/second.img/mango5.jpg" onclick="changephoto(this)"></li>
			</ul>
			...
			<div class="moreinformation">
				  ...
				  <div id="jieshao"class="tag">
						<img src="img/jieshao.img/mangoj1.jpg" >
						<img src="img/jieshao.img/mangoj2.jpg" >
						<img src="img/jieshao.img/mangoj3.jpg" >
						<img src="img/jieshao.img/mangoj4.jpg" >
						<img src="img/jieshao.img/mangoj7.jpg" >
				  </div>
