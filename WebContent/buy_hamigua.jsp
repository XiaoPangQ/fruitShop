...
<html>
	...
	<body>
		<div class="f_show">
			<div class="f_photo">
				<img src="img/second.img/hamigua1.jpg" id="showphoto">
			</div>
		
			<div class="f_information">
				
				<div class="f_name">
					<h3><span id="trade_name">蜜鲜果城：</span>【东坡馆】<span id="proName">西州哈蜜瓜</span> 新鲜精品果4-5斤/箱</h3>
					<p id="slogan">【头茬芒果,鲜嫩美味】拍2件合包裹8斤发~精选单果80-120g的黄金比例果；皮薄核小,清甜多汁!</p>
				</div>
			
				<div class="f_price">
					<div id="price1">
						<p >价&nbsp;格<span id="proPrice">22.50￥</span></p>
					</div>
					<div id="price2">
						<p >促&nbsp;销<span id="promotion">满22元减3元，满64元减12元！</span></p>
					</div>
				</div>
				<div class="f_id">
					<span>水果编号：<span id="proId">113</span></span>
				</div>
			...
			<ul id="photolist">
				<li><img src="img/second.img/hamigua1.jpg" onclick="changephoto(this)"></li>
				<li><img src="img/second.img/hamigua2.jpg" onclick="changephoto(this)"></li>
				<li><img src="img/second.img/hamigua3.jpg" onclick="changephoto(this)"></li>
				<li><img src="img/second.img/hamigua4.jpg" onclick="changephoto(this)"></li>
				<li><img src="img/second.img/hamigua5.jpg" onclick="changephoto(this)"></li>
			</ul>
			...
			<div class="moreinformation">
				  ...
				  <div id="jieshao"class="tag">
						<img src="img/jieshao.img/hamiguaj1.jpg" >
						<img src="img/jieshao.img/hamiguaj2.jpg" >
						<img src="img/jieshao.img/hamiguaj3.jpg" >
						<img src="img/jieshao.img/hamiguaj4.jpg" >
						<img src="img/jieshao.img/hamiguaj5.jpg" >
				  </div>
				  ...
				  <div id="shouhou" class="tag">
						<img src="img/jieshao.img/mangoj5.JPG" >
				  </div>
				  <div id="evaluate" class="tag">
				  	<img src="img/jieshao.img/mangoj6.JPG" >
				  </div>
				</div>
			</div>
	</body>
